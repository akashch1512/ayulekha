  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-blue-100">
      <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-md text-center">
        <h2 className="text-2xl text-blue-700 mb-4">Welcome to User Dashboard</h2>
        <p className="text-gray-600 mb-4">Manage your medical history and other details here.</p>
